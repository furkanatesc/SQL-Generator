...
from app.evaluation.mysql_seed import split_statements, apply_seed, MYSQL_SEED_VERSION


def test_version_constant():
    assert MYSQL_SEED_VERSION == "v1"
...
def test_mysql_seed_import_does_not_load_db_drivers():
